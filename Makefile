LANGUAGE_NAME := tree-sitter-ganezdragon-perl
HOMEPAGE_URL := git://github.com/ganezdragon/tree-sitter-perl.git
VERSION := 1.1.2
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ganezdragon-perl '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ganezdragon-perl
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ganezdragon-perl
